...
Although all examples use `<script src="https://github.com/Cognigy/Webchat/releases/latest/download/webchat.js"></script>` to load the webchat script **it is recommended you run a local version of the script in your page**.
